...
BUILTIN_COMMANDS: tuple[CommandEntry, ...] = (
    ...
    CommandEntry("/agent", "Multi-agent orchestration", "Tools", ("team", "tmux", "orchestrate")),
    ...
    CommandEntry("/performance", "Show LLM speed metrics", "Context", ("speed", "throughput", "perf", "tok/s")),
