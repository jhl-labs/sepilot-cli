...
export const SETTINGS_SCHEMA = {
  ...
  openAIApiKey: {
    ...
    requiresRestart: true,
    default: undefined as string | undefined,
    description: 'OpenAI API Key for using OpenAI models.',
    showInDialog: false,
  },
  openAIBaseURL: {
    type: 'string',
  ...
  openAIModel: {
    ...
    category: 'General',
    requiresRestart: false,
    default: 'gpt-4o' as string,
    description: 'The OpenAI model to use for conversations.',
    showInDialog: false,
  },
  openAIEmbeddingModel: {
    ...
    category: 'General',
    requiresRestart: false,
    default: 'text-embedding-3-small' as string,
  ...
  useOpenAI: {
    ...
    requiresRestart: true,
    default: false,
    description: 'Use OpenAI API instead of Google Gemini.',
    showInDialog: true,
  },
