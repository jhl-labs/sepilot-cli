...
// Environment variables the child always needs to behave like a normal shell
// command (locate binaries, resolve $HOME, honor locale). These are kept even
// though they are inherited from the daemon; none of them carries a secret.
